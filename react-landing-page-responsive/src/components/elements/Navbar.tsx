    ...
    >
      <Container>
        <nav className="w-full flex justify-between gap-6 relative py-4">
          ...
          <div className="min-w-max inline-flex relative">
            ...
            >
              <img
                src={logo}
                alt="RecruitO Logo"
                className="w-10 h-10 transition-transform duration-300 group-hover:rotate-6 group-hover:scale-110"
              />
              <div className="inline-flex text-lg font-semibold text-heading-1">
                RecruitO
              </div>
          ...
          <div
            className="flex flex-col lg:flex-row w-full lg:justify-between lg:items-center 
                       absolute top-full left-0 lg:static lg:top-0 bg-body/95 lg:bg-transparent 
                       border-x border-x-box-border lg:border-x-0 lg:h-auto h-0 overflow-hidden"
          >
            <ul
              className="border-t border-box-border lg:border-t-0 px-6 lg:px-0 
                         pt-6 lg:pt-0 flex flex-col lg:flex-row gap-y-4 gap-x-6 
                         text-lg text-heading-2 w-full lg:justify-center lg:items-center"
            >
              {navItems.map((item, key) => (
                <li
          ...
          <div className="min-w-max flex items-center gap-x-3">
            <button
              onClick={toggleTheme}
              className="
                outline-hidden flex relative text-heading-2
                rounded-full p-2 lg:p-3
                border border-box-border
                cursor-pointer
                transition-all duration-300
                hover:bg-white/10 hover:rotate-12
              "
            >
              {theme === "dark" ? (
                <svg
